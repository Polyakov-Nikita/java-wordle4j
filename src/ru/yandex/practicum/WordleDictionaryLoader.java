...
public class WordleDictionaryLoader implements Loggable {
    ...
    public WordleDictionary load() throws IOException, EmptyDictionaryFileException {
    ...
    private List<String> readAllWords() throws IOException, EmptyDictionaryFileException {
    ...
    private void checkEmptiness(List<String> lines) throws EmptyDictionaryFileException {
        if (lines.isEmpty()) {
